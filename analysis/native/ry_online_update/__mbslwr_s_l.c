/* 1014b557 __mbslwr_s_l [[1014b557, 1014b657]] */
...

{
  ...
  if (_Str == (uchar *)0x0) {
    if (_SizeInBytes != 0) goto LAB_1014b57e;
  }
  else if (_SizeInBytes == 0) goto LAB_1014b57e;
  if (_Str == (uchar *)0x0) {
    return 0;
  }
...
LAB_1014b620:
        ...
        iVar5 = ___acrt_LCMapStringA
                          (local_18,*(wchar_t **)(iVar7 + 0x21c),0x100,(char *)pbVar8,2,
