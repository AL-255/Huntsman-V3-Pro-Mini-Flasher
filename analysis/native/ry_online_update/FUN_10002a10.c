/* 10002a10 FUN_10002a10 [[10002a10, 10002aca]] */

void __fastcall FUN_10002a10(int param_1,int param_2,int param_3)

{
  ...
  for (; (param_1 != param_2 && (param_1 != 0)); param_1 = *(int *)(param_1 + 0xc)) {
    ...
    case 10:
    case 0xb:
      FUN_10002a10(*(int *)(param_1 + 0x14),0,0);
      break;
    case 0x10:
      if (param_3 != 0) {
      ...
      for (iVar1 = *(int *)(param_1 + 0x18); iVar1 != 0; iVar1 = *(int *)(iVar1 + 0x18)) {
        FUN_10002a10(*(int *)(iVar1 + 0xc),*(int *)(iVar1 + 0x14),param_3);
      }
      break;
    case 0x12:
      iVar2 = param_1;
