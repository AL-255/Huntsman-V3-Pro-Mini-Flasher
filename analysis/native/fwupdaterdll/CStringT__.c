/* 10006820 CStringT<> [[10006820, 10006843]] */
...
/* Library Function - Multiple Matches With Same Base Name
   ...
   ATL::ChTraitsCRT<wchar_t> > >(wchar_t const *,int,struct ATL::IAtlStringMgr *)
    public: __thiscall ATL::CStringT<wchar_t,class StrTraitMFC<wchar_t,class
...
void * __thiscall CStringT<>(void *this,wchar_t *param_1,uint param_2,undefined4 *param_3)

{
  FUN_10006e50(this,param_1,param_2,param_3);
  return this;
}
