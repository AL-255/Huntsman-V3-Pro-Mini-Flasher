/* 1013cb8e FUN_1013cb8e [[1013cb8e, 1013cdf8]] */

undefined1 (*) [16] __cdecl FUN_1013cb8e(undefined1 (*param_1) [16],undefined1 (*param_2) [16])
...
LAB_1013cc11:
      while( true ) {
        while( true ) {
          ...
          if (*(ushort *)*param_1 == 0) goto LAB_1013cdee;
          pauVar6 = param_1;
          if (*(ushort *)*param_1 == uVar1) goto LAB_1013cc43;
...
LAB_1013cc91:
            ...
            if (*(short *)*param_1 != *(short *)*pauVar5) goto LAB_1013cca9;
            pauVar5 = (undefined1 (*) [16])(*pauVar5 + 2);
          }
          uVar2 = (uint)pauVar5 & 0xfff;
          if (0xff0 < uVar2) goto LAB_1013cc91;
          pcmpistri(*pauVar5,*param_1,0xd);
          if (!SBORROW4(uVar2,0xff0)) goto LAB_1013cca9;
...
LAB_1013cd25:
      ...
      do {
        ...
        } while ((*(short *)(*pauVar5 + local_18) == *(short *)*pauVar5) &&
                (pauVar5 = (undefined1 (*) [16])(*pauVar5 + 2), *(short *)(*pauVar5 + local_18) != 0
                ));
        if (*(short *)*pauVar5 == 0) {
          return param_1;
        }
